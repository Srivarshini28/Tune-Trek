...
public class uyirin_uyireActivity extends AppCompatActivity {
            ...
            Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_uyirin_uyire);

        // Initialize MediaPlayer
        music = MediaPlayer.create(this, R.raw.uyerin_uyere);
